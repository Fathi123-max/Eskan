...
import 'package:haider/views/used/currentUserPropertyDetail.dart';
    ...
    return Scaffold(
        ...
        body: Obx(() {
          if (rentOutController.isLoading == true) {
            ...
            return rentOutController.quary == null
                ? Center(
                    child: Text(
                      "لم تضف عقارات بعد",
                      style: TextStyle(
                ...
                : Padding(
                    ...
                    child: FirestoreListView<Map<String, dynamic>>(
                      ...
                      query: rentOutController.quary!,
                      itemBuilder: (context, snapshot) {
                        final property = PropertyModel.fromMap(snapshot.data());
                        return InkWell(
                          onTap: () => Get.to(() =>
                              CurrentUserPropertyDetail(property: property)),
                          child: Container(
                            ...
                            child: ClipRRect(
                              ...
                              child: Stack(
                                children: [
                                  CachedNetworkImage(
                                    imageUrl:
                                        property.images![0], // URL of the image
                                    fit: BoxFit.cover,
